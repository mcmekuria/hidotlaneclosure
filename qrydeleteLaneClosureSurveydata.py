...
# select all objects that are in the survey
fld1 = "objectid" # "ApproverL1"
qryStr = "{} is not null".format(fld1) #,'Albert Chung')
norteqry = lnclhdrlyr.query(where=qryStr)
...
if len(norteqry)>0:
    ...
    resultdel = lnclhdrlyr.delete_features(where=norteid)


print (" End lane closure processing of {} features with {} ".format (len(norteqry),qryStr))
